...
логика офферов реализована в api/offers.py (использует functions.calculate),
...
@pytest.mark.skip(reason="functions.offers не существует; используется api/offers + functions.calculate")
